...
public class ReducerWorker {
    ...
    public static void main(String[] args) throws Exception{
        ...
        while (args.length > 4 && reduceDirPath.equalsIgnoreCase("reduceroutput_" + args[4])); // to simulate fault tolerance
        MapReduce mr = new MapReduce();
        Reducer obj = null;
        try {
            obj = mr.getReducerObject(reducerKey); // get from RMI registry
        } catch (Exception e) {
            e.printStackTrace();
            throw e;
        }
